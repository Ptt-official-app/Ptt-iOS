...
//  Ptt
//
//  Created by denkeni on Jan 19, 2021.
...
class StyleKit: NSObject {
    ...
    class func drawPasswdVisibilitySelected(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 18, height: 11), resizing: ResizingBehavior = .aspectFit) {
        ...
        visibility24px2.addCurve(to: CGPoint(x: 0, y: 5.5), controlPoint1: CGPoint(x: 4.91, y: 0), controlPoint2: CGPoint(x: 1.42, y: 2.28))
        visibility24px2.addCurve(to: CGPoint(x: 9, y: 11), controlPoint1: CGPoint(x: 1.42, y: 8.72), controlPoint2: CGPoint(x: 4.91, y: 11))
        visibility24px2.addCurve(to: CGPoint(x: 18, y: 5.5), controlPoint1: CGPoint(x: 13.09, y: 11), controlPoint2: CGPoint(x: 16.58, y: 8.72))
        visibility24px2.addCurve(to: CGPoint(x: 9, y: 0), controlPoint1: CGPoint(x: 16.58, y: 2.28), controlPoint2: CGPoint(x: 13.09, y: 0))
        visibility24px2.close()
        visibility24px2.move(to: CGPoint(x: 9, y: 9.17))
        visibility24px2.addCurve(to: CGPoint(x: 4.91, y: 5.5), controlPoint1: CGPoint(x: 6.74, y: 9.17), controlPoint2: CGPoint(x: 4.91, y: 7.52))
        visibility24px2.addCurve(to: CGPoint(x: 9, y: 1.83), controlPoint1: CGPoint(x: 4.91, y: 3.48), controlPoint2: CGPoint(x: 6.74, y: 1.83))
        visibility24px2.addCurve(to: CGPoint(x: 13.09, y: 5.5), controlPoint1: CGPoint(x: 11.26, y: 1.83), controlPoint2: CGPoint(x: 13.09, y: 3.48))
        visibility24px2.addCurve(to: CGPoint(x: 9, y: 9.17), controlPoint1: CGPoint(x: 13.09, y: 7.52), controlPoint2: CGPoint(x: 11.26, y: 9.17))
        visibility24px2.close()
        visibility24px2.move(to: CGPoint(x: 9, y: 3.3))
        visibility24px2.addCurve(to: CGPoint(x: 6.55, y: 5.5), controlPoint1: CGPoint(x: 7.64, y: 3.3), controlPoint2: CGPoint(x: 6.55, y: 4.28))
        visibility24px2.addCurve(to: CGPoint(x: 9, y: 7.7), controlPoint1: CGPoint(x: 6.55, y: 6.72), controlPoint2: CGPoint(x: 7.64, y: 7.7))
        visibility24px2.addCurve(to: CGPoint(x: 11.45, y: 5.5), controlPoint1: CGPoint(x: 10.36, y: 7.7), controlPoint2: CGPoint(x: 11.45, y: 6.72))
        visibility24px2.addCurve(to: CGPoint(x: 9, y: 3.3), controlPoint1: CGPoint(x: 11.45, y: 4.28), controlPoint2: CGPoint(x: 10.36, y: 3.3))
        visibility24px2.close()
        context.saveGState()
        visibility24px2.usesEvenOddFillRule = true
        UIColor(hue: 0.667, saturation: 0.028, brightness: 0.969, alpha: 1).setFill()
    ...
    class func drawPasswdVisibility(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 18, height: 11), resizing: ResizingBehavior = .aspectFit) {
        ...
        visibility24px.addCurve(to: CGPoint(x: 0, y: 5.5), controlPoint1: CGPoint(x: 4.91, y: 0), controlPoint2: CGPoint(x: 1.42, y: 2.28))
        visibility24px.addCurve(to: CGPoint(x: 9, y: 11), controlPoint1: CGPoint(x: 1.42, y: 8.72), controlPoint2: CGPoint(x: 4.91, y: 11))
        visibility24px.addCurve(to: CGPoint(x: 18, y: 5.5), controlPoint1: CGPoint(x: 13.09, y: 11), controlPoint2: CGPoint(x: 16.58, y: 8.72))
        visibility24px.addCurve(to: CGPoint(x: 9, y: 0), controlPoint1: CGPoint(x: 16.58, y: 2.28), controlPoint2: CGPoint(x: 13.09, y: 0))
        visibility24px.close()
        visibility24px.move(to: CGPoint(x: 9, y: 9.17))
        visibility24px.addCurve(to: CGPoint(x: 4.91, y: 5.5), controlPoint1: CGPoint(x: 6.74, y: 9.17), controlPoint2: CGPoint(x: 4.91, y: 7.52))
        visibility24px.addCurve(to: CGPoint(x: 9, y: 1.83), controlPoint1: CGPoint(x: 4.91, y: 3.48), controlPoint2: CGPoint(x: 6.74, y: 1.83))
        visibility24px.addCurve(to: CGPoint(x: 13.09, y: 5.5), controlPoint1: CGPoint(x: 11.26, y: 1.83), controlPoint2: CGPoint(x: 13.09, y: 3.48))
        visibility24px.addCurve(to: CGPoint(x: 9, y: 9.17), controlPoint1: CGPoint(x: 13.09, y: 7.52), controlPoint2: CGPoint(x: 11.26, y: 9.17))
        visibility24px.close()
        visibility24px.move(to: CGPoint(x: 9, y: 3.3))
        visibility24px.addCurve(to: CGPoint(x: 6.55, y: 5.5), controlPoint1: CGPoint(x: 7.64, y: 3.3), controlPoint2: CGPoint(x: 6.55, y: 4.28))
        visibility24px.addCurve(to: CGPoint(x: 9, y: 7.7), controlPoint1: CGPoint(x: 6.55, y: 6.72), controlPoint2: CGPoint(x: 7.64, y: 7.7))
        visibility24px.addCurve(to: CGPoint(x: 11.45, y: 5.5), controlPoint1: CGPoint(x: 10.36, y: 7.7), controlPoint2: CGPoint(x: 11.45, y: 6.72))
        visibility24px.addCurve(to: CGPoint(x: 9, y: 3.3), controlPoint1: CGPoint(x: 11.45, y: 4.28), controlPoint2: CGPoint(x: 10.36, y: 3.3))
        visibility24px.close()
        context.saveGState()
        visibility24px.usesEvenOddFillRule = true
    ...
    class func drawPopularBoard(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit) {
        ...
        do {
            ...
            do {
                ...
                let fill1 = UIBezierPath()
                fill1.move(to: CGPoint.zero)
                fill1.addLine(to: CGPoint(x: 17, y: 0))
                fill1.addLine(to: CGPoint(x: 17, y: 4))
                fill1.addLine(to: CGPoint(x: 0, y: 4))
                fill1.addLine(to: CGPoint.zero)
                fill1.close()
                context.saveGState()
                context.translateBy(x: 0.5, y: 0.5)
                ...
                fill2.addLine(to: CGPoint(x: 1, y: 4))
                fill2.addLine(to: CGPoint(x: 17, y: 4))
                fill2.addLine(to: CGPoint(x: 17, y: 1))
                fill2.addLine(to: CGPoint(x: 1, y: 1))
                fill2.addLine(to: CGPoint(x: 1, y: 1))
                fill2.close()
                fill2.move(to: CGPoint.zero)
                fill2.addLine(to: CGPoint(x: 18, y: 0))
                fill2.addLine(to: CGPoint(x: 18, y: 5))
                fill2.addLine(to: CGPoint(x: 0, y: 5))
                fill2.addLine(to: CGPoint.zero)
                fill2.close()
                context.saveGState()
                fill2.usesEvenOddFillRule = true
                UIColor(hue: 0.667, saturation: 0.081, brightness: 0.58, alpha: 1).setFill()
            ...
            do {
                ...
                let fill4 = UIBezierPath()
                fill4.move(to: CGPoint.zero)
                fill4.addLine(to: CGPoint(x: 17, y: 0))
                fill4.addLine(to: CGPoint(x: 17, y: 4))
                fill4.addLine(to: CGPoint(x: 0, y: 4))
                fill4.addLine(to: CGPoint.zero)
                fill4.close()
                context.saveGState()
                context.translateBy(x: 0.5, y: 0.5)
                ...
                fill5.addLine(to: CGPoint(x: 1, y: 4))
                fill5.addLine(to: CGPoint(x: 17, y: 4))
                fill5.addLine(to: CGPoint(x: 17, y: 1))
                fill5.addLine(to: CGPoint(x: 1, y: 1))
                fill5.addLine(to: CGPoint(x: 1, y: 1))
                fill5.close()
                fill5.move(to: CGPoint.zero)
                fill5.addLine(to: CGPoint(x: 18, y: 0))
                fill5.addLine(to: CGPoint(x: 18, y: 5))
                fill5.addLine(to: CGPoint(x: 0, y: 5))
    ...
    class func drawFBPage(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 26, height: 26), resizing: ResizingBehavior = .aspectFit) {
        ...
        do {
            ...
            do {
                ...
                clip2.addLine(to: CGPoint(x: 24, y: 0))
                clip2.addLine(to: CGPoint(x: 24, y: 23.85))
                clip2.addLine(to: CGPoint(x: 0, y: 23.85))
                ...
                fill1.addCurve(to: CGPoint(x: 12, y: 0), controlPoint1: CGPoint(x: 24, y: 5.37), controlPoint2: CGPoint(x: 18.63, y: 0))
                fill1.addCurve(to: CGPoint(x: 0, y: 12), controlPoint1: CGPoint(x: 5.37, y: 0), controlPoint2: CGPoint(x: 0, y: 5.37))
                fill1.addCurve(to: CGPoint(x: 10.13, y: 23.85), controlPoint1: CGPoint(x: 0, y: 17.99), controlPoint2: CGPoint(x: 4.39, y: 22.95))
                fill1.addLine(to: CGPoint(x: 10.13, y: 15.47))
                fill1.addLine(to: CGPoint(x: 7.08, y: 15.47))
                fill1.addLine(to: CGPoint(x: 7.08, y: 12))
                fill1.addLine(to: CGPoint(x: 10.13, y: 12))
                fill1.addLine(to: CGPoint(x: 10.13, y: 9.36))
                fill1.addCurve(to: CGPoint(x: 14.66, y: 4.69), controlPoint1: CGPoint(x: 10.13, y: 6.35), controlPoint2: CGPoint(x: 11.92, y: 4.69))
                fill1.addCurve(to: CGPoint(x: 17.34, y: 4.92), controlPoint1: CGPoint(x: 15.97, y: 4.69), controlPoint2: CGPoint(x: 17.34, y: 4.92))
                fill1.addLine(to: CGPoint(x: 17.34, y: 7.88))
                fill1.addLine(to: CGPoint(x: 15.83, y: 7.88))
                fill1.addCurve(to: CGPoint(x: 13.88, y: 9.75), controlPoint1: CGPoint(x: 14.34, y: 7.88), controlPoint2: CGPoint(x: 13.88, y: 8.8))
                fill1.addLine(to: CGPoint(x: 13.88, y: 12))
                fill1.addLine(to: CGPoint(x: 17.2, y: 12))
                fill1.addLine(to: CGPoint(x: 16.67, y: 15.47))
                fill1.addLine(to: CGPoint(x: 13.88, y: 15.47))
                fill1.addLine(to: CGPoint(x: 13.88, y: 23.85))
                fill1.addCurve(to: CGPoint(x: 24, y: 12), controlPoint1: CGPoint(x: 19.61, y: 22.95), controlPoint2: CGPoint(x: 24, y: 17.99))
                context.saveGState()
                fill1.usesEvenOddFillRule = true
            ...
            fill4.addLine(to: CGPoint(x: 10.13, y: 7.31))
            fill4.addLine(to: CGPoint(x: 6.8, y: 7.31))
            fill4.addLine(to: CGPoint(x: 6.8, y: 5.06))
            fill4.addCurve(to: CGPoint(x: 8.75, y: 3.19), controlPoint1: CGPoint(x: 6.8, y: 4.11), controlPoint2: CGPoint(x: 7.26, y: 3.19))
            fill4.addLine(to: CGPoint(x: 10.27, y: 3.19))
            fill4.addLine(to: CGPoint(x: 10.27, y: 0.23))
            fill4.addCurve(to: CGPoint(x: 7.58, y: 0), controlPoint1: CGPoint(x: 10.27, y: 0.23), controlPoint2: CGPoint(x: 8.89, y: 0))
            fill4.addCurve(to: CGPoint(x: 3.05, y: 4.67), controlPoint1: CGPoint(x: 4.84, y: 0), controlPoint2: CGPoint(x: 3.05, y: 1.66))
            fill4.addLine(to: CGPoint(x: 3.05, y: 7.31))
            fill4.addLine(to: CGPoint(x: 0, y: 7.31))
            fill4.addLine(to: CGPoint(x: 0, y: 10.78))
            fill4.addLine(to: CGPoint(x: 3.05, y: 10.78))
            fill4.addLine(to: CGPoint(x: 3.05, y: 19.17))
            fill4.addCurve(to: CGPoint(x: 4.92, y: 19.31), controlPoint1: CGPoint(x: 3.66, y: 19.26), controlPoint2: CGPoint(x: 4.28, y: 19.31))
            fill4.addCurve(to: CGPoint(x: 6.8, y: 19.17), controlPoint1: CGPoint(x: 5.56, y: 19.31), controlPoint2: CGPoint(x: 6.19, y: 19.26))
            fill4.addLine(to: CGPoint(x: 6.8, y: 10.78))
            fill4.addLine(to: CGPoint(x: 9.59, y: 10.78))
            context.saveGState()
